...
namespace AdventOfCode.Year2019
{
    ...
    class Day17
    {
        ...
        public Day17(string input = Input)
        {
        ...
        private void BuildMap()
        {
            ...
            {
                char c = (char)cmp.Output.Dequeue();
                switch (c)
                {
                    case '\n':
                        y++;
        ...
        internal long Part2()
        {
            cmp.SetAddressValue(0, 2);
            foreach (char c in "A,B,A,C,A,B,C,C,A,B\nR,8,L,10,R,8\nR,12,R,8,L,8,L,12\nL,12,L,10,L,8\nn\n")
                cmp.InputQueue.Enqueue(c);
            cmp.RunToFinish();

            long result = 0;
            while (cmp.Output.Count > 0)
            {
                long r = cmp.Output.Dequeue();
                if (r > 128)
                {
                    result += r;
                }
    ...
    public class TestDay17
    {
        ...
        public void Part1()
        {
            Assert.AreEqual(2804, new Day17().Part1());
        }
        [TestMethod]
        public void Part2()
        {
            Assert.AreEqual(833429, new Day17().Part2());
        }
    }
